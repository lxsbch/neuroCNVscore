...
The full feature names could be found below (or from supplementary table for more details). They are from various sources including ENCODE, EpiMap, UCSC genome browser, PsychENCODE, HPO, Clinvar, enhancer centered databases, and github page from MacArthur's Lab  etc.
To use these data other than research, please makes sure to meet the requirements of corresponding data sources. 
